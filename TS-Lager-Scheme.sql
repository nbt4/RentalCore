...
CREATE TABLE `job_templates` (
  ...
  `default_notes` text,
  `pricing_template` json DEFAULT NULL,
...
ALTER TABLE `job_templates`
  ...
  ADD KEY `created_by` (`created_by`),
  ADD KEY `idx_category_active` (`jobcategoryID`,`is_active`),
...
ALTER TABLE `jobs`
  ...
  ADD CONSTRAINT `jobs_ibfk_4` FOREIGN KEY (`templateID`) REFERENCES `job_templates` (`templateID`) ON DELETE SET NULL,
