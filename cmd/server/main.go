...
func main() {
	...
	// Routes
	setupRoutes(r, jobHandler, deviceHandler, customerHandler, statusHandler, productHandler, barcodeHandler, scannerHandler)
...
func setupRoutes(r *gin.Engine, 
	...
	r.GET("/", func(c *gin.Context) {
		c.HTML(http.StatusOK, "home_new.html", gin.H{"title": "Home"})
	})
